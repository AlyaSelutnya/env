# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2022-01-11 23:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_name', models.CharField(db_index=True, max_length=200)),
                ('_slug', models.SlugField(max_length=200, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ('_name', models.CharField(db_index=True, max_length=200)),
                ('_slug', models.SlugField(max_length=200)),
